...
export class ArticlesController {
  ...
  @ApiResponse({ status: 200, description: 'Returns paginated articles', type: PaginatedArticlesDto })
  findAll(
  ...
  @ApiQuery({ name: 'category', required: false, type: String })
  @ApiQuery({ name: 'search', required: false, type: String })
  @ApiResponse({ status: 200, description: 'Returns paginated published articles', type: PaginatedArticlesDto })
  findPublished(
    @Query('page', new DefaultValuePipe(1), ParseIntPipe) page = 1,
    @Query('limit', new DefaultValuePipe(10), ParseIntPipe) limit = 10,
    @Query('category') category?: string,
  ...
  @ApiResponse({ status: 200, description: 'Returns the article', type: Article })
